...
public class WebService : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public string AtletaSalvar(string param1, string param2, string param3, string param4, string param5, 
    ...
    [WebMethod]
    public string AtletaExcluir(string param1)
    {
        string url;

        OperacaoBanco operacao3 = new OperacaoBanco();
        Boolean deletar = operacao3.Delete("delete from tbl_Atletas where ID_Atleta =" + param1);
        ConexaoBancoSQL.fecharConexao();
    ...
    [WebMethod]
    public string AtletaAlterar(string param1, string param2, string param3, string param4, string param5,
       string param6, string param7, string param8, string param9, string param10,
       string param11, string param12, string param13, string param14, string param15,
